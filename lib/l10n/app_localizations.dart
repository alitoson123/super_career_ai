...
abstract class AppLocalizations {
  ...
  /// No description provided for @superCareer.
  ///
  ...
  /// No description provided for @avgMatchScore.
  ///
  /// In en, this message translates to:
  /// **'Avg Match Score'**
  String get avgMatchScore;

  /// No description provided for @activeProposals.
  ///
  /// In en, this message translates to:
  /// **'Active Proposals'**
  ...
  /// No description provided for @recentJobMatches.
  ///
  /// In en, this message translates to:
  /// **'Recent Job Matches'**
  String get recentJobMatches;

  /// No description provided for @recentProjectMatches.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @viewMatchAndApply.
  ///
  /// In en, this message translates to:
  /// **'View Match & Apply'**
  ...
  /// No description provided for @jops.
  ///
  /// In en, this message translates to:
  /// **'JOPS'**
  String get jops;
  ...
  /// No description provided for @jopMatchesTitle.
  ///
  /// In en, this message translates to:
  /// **'Jop Matches'**
  String get jopMatchesTitle;

  /// No description provided for @searchMatchedJobs.
  ///
  /// In en, this message translates to:
  /// **'Search matched jobs'**
  ...
  /// No description provided for @matchBreakdown.
  ///
  /// In en, this message translates to:
  /// **'Match Breakdown'**
  ...
  /// No description provided for @skillsMatched.
  ///
  /// In en, this message translates to:
  /// **'{matched}/{total} Skills matched'**
  String skillsMatched(int matched, int total);

  /// No description provided for @preferredTimezone.
  ///
  /// In en, this message translates to:
  /// **'Preferred timezone'**
  String get preferredTimezone;

  /// No description provided for @budgetRangeMatch.
  ///
  /// In en, this message translates to:
  /// **'Budget range match'**
